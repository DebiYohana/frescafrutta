...
import hobby1 from '../joging.jpg';
import hobby2 from '../demuss.jpg';
import hobby3 from '../makann.jpg';
import hobby4 from '../bacabuku.jpg';

const HobbiesGallery: React.FC = () => {
  const hobbies = [
    { id: 1, title: 'Joging', image: hobby1 },
    { id: 2, title: 'Mendengarkan Musik', image: hobby2 },
    { id: 3, title: 'Makan', image: hobby3 },
    { id: 4, title: 'Baca Buku', image: hobby4 },
  ];
